...
namespace IIS.Горводоканал
{
    ...
    [View("ВидОбращенияL", new string[] {
            ...
            "Актуально as \'Актуально\'",
            "ТипОбращения.Название as \'Название\'"})]
    public class ВидОбращения : IIS.Горводоканал.Справочник
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВидОбращенияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВидОбращенияE", typeof(IIS.Горводоканал.ВидОбращения));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ВидОбращенияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВидОбращенияL", typeof(IIS.Горводоканал.ВидОбращения));
                }
            }
        }
    }
